...
@Nonnull
@ResourceRole(name = "ProjectManagement", code = "project-management", scope = "UI")
public interface ProjectManagementRole {
    ...
    @MenuPolicy(menuIds = {"Project.browse", "Task_.browse", "Document.browse", "User.browse"})
    @ScreenPolicy(screenIds = {"Project.browse", "Project.edit", "Task_.browse", "Task_.edit", "Document.browse", "Document.edit", "User.browse", "User.edit"})
    void screens();
}